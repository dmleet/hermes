...
- **MusicBrainz**: resolution. Each recording or typed request becomes one release group,
  ...
  its release-group genres are what the queue shows beside each album, and its artist and
  release-group searches feed the request form's suggestions. One rate limiter, one
